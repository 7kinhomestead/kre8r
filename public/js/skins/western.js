/**
 * WESTERN — Creator skin ($12) — "I'm your huckleberry."
 * A full western narrative universe. Western (1993) aesthetic: warm sepia,
 ...
 * server-side in src/routes/mission.js (CREW_PERSONAS['western']). The crew map
 * here drives the display name/title/color shown in the Comm Window.
 *
 * Loaded by SkinManager. Written to :root under [data-skin="western"].
 */
window.SKIN_WESTERN = {
  meta: {
    id: 'western',
    ...
    era: "Western Territory, 1881 — \"I'm your huckleberry.\"",
    version: '1.0.0',
    tier: 'creator',
    price_usd: 12,
  ...
  // System prompts are server-side in CREW_PERSONAS['western'] (mission.js).
  crew: {
    'number-one': { name: 'DOC HOLLIDAY',      title: 'FIRST GUN · 7 KIN HOMESTEAD',    color: '#d97706', glyph: '🃏' },
    'grex':       { name: 'BANKER McCLELLAND', title: 'SILVER BANKER · WESTERN',       color: '#b45309', glyph: '🪙' },
    'dale':       { name: 'DEPUTY FITCH',      title: 'TOWN DEPUTY · WESTERN',         color: '#92400e', glyph: '⭐' },
    'vaelyn':     { name: 'BELLE CAVENDISH',   title: 'SALOON PROPRIETOR · WESTERN',   color: '#d97706', glyph: '♠' },
    'axiom':      { name: 'WIRE OPERATOR',     title: 'TELEGRAPH OFFICE · WESTERN',    color: '#0891b2', glyph: '—·—' },
  },
