...
**Your move this week:** Drive your ground rod (borrow the SDS-Max, save your marriage) and run your frame-to-frame bonding jumper. Then settle your *one* bond: confirm your inverter's internal N-G bond is on for off-grid (on the SunGold, item #63), and wire the panel it feeds as a **subpanel** — neutral floated off the box, ground bus bonded, no N-G screw. Plug an outlet tester into a receptacle and confirm it reads "correct," not "open neutral." Don't connect any power yet. We size the cables next.
