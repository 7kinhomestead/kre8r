...
Here's where it gets specific to *your* box. That one bond can live in two places, and you pick **one**. Either the **inverter makes it internally** — a lot of all-in-ones have a setting for it; on my SunGold it's menu item **#63** ("automatic switching of N-G connection"), and switched on it bonds neutral-to-ground inside the box whenever I'm off-grid, then drops the bond automatically if grid or generator power ever feeds in — **or** you turn that setting **off** and **make the bond yourself at the main panel**, the same spot you'd find it in any normal house. I bond at the panel, because it's a jumper I can actually *see*, and I keep #63 off so the inverter isn't quietly making a second one behind my back. For a *permanently* grid-tied system you'd disable the bond entirely — the utility already made it at the service entrance, and that's the two-bond problem all over again.

And here's the ten-dollar way to *prove* you nailed it: with no grid feeding in, plug a cheap **outlet tester** into your output. **"Correct"** means your one bond is live and doing its job. **"Open neutral"** means you've got *zero* bonds — go make one. Don't eyeball this; test it. **Verify exactly where that single bond physically lives in your build — your inverter's manual is the final word.**
...
**What you'll take:** Bonding ties your metal together; grounding ties your system to the earth — and you do both *before* any power connection. The one number to tattoo on the inside of your eyelids: **exactly one neutral-ground bond.** Either your inverter makes it (a setting like SunGold's #63) or you make it at the main panel — never both — and a $10 outlet tester reading "correct" is how you prove it.

**Your move this week:** Drive your ground rod (borrow the SDS-Max, save your marriage) and run your frame-to-frame bonding jumper. Then decide where your *one* bond lives: either confirm your inverter's bonding setting is on for off-grid, or switch it off and land a bonding jumper in your main panel. Plug an outlet tester into the output and confirm it reads "correct," not "open neutral." Don't connect any power yet. We size the cables next.
